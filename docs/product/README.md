...
**Branch context:** `main` after PR #24 (`Outline Document Composer Slice 1`)
...
| Synopsis Composer implementation | `docs/product/synopsis-composer-prd.md` | Implementation PRD written; ready to build after review. Mirrors Outline composer. Treatment and Story Bible Composers follow in later slices |
