...
- `docs/product/script-workflow-polish-prd.md` is canonical for the approved post-foundation Script workflow polish slice: title page metadata/preview, pagination foundation, Script Facts, scratchpad sidebar, script status/locking flag, and character/location autocomplete.
