...
import { SynopsisViewToggle } from '../../client/src/components/writing/synopsis/SynopsisViewToggle'

describe('SynopsisViewToggle', () => {
  it('renders both segments', () => {
    render(<SynopsisViewToggle value="edit" onChange={vi.fn()} />)
    expect(screen.getByText('Edit')).toBeInTheDocument()
    expect(screen.getByText('Document')).toBeInTheDocument()
  })

  it('marks the active segment via aria-pressed matching the value prop', () => {
    render(<SynopsisViewToggle value="document" onChange={vi.fn()} />)
  ...
  it('clicking the inactive segment calls onChange with the other value', () => {
    ...
    render(<SynopsisViewToggle value="edit" onChange={onChange} />)
