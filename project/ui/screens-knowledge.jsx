// =============================================================================
//  ui/screens-knowledge.jsx
//  Hive Mind · Structure · Cast · World · Scenes
// =============================================================================
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
          <thead>
            <tr style={{ color: 'var(--fg-muted)', fontFamily: 'var(--mono)', fontSize: 10, textTransform: 'uppercase', letterSpacing: 1 }}>
              <th style={th}>#</th><th style={th}>Scene</th><th style={th}>Beat</th><th style={th}>Cast</th><th style={th}>Words</th><th style={th}>Status</th><th style={th}>Flags</th>
            </tr>
          </thead>
          <tbody>
            {scenes.map(s => (
              <tr key={s.id} style={{ borderTop: '1px solid var(--border)' }}>
                ...
                <td style={td}><span style={{ fontFamily: 'var(--serif)', fontSize: 13 }}>{s.title}</span><div style={{ fontSize: 10.5, color: 'var(--fg-muted)', fontFamily:'var(--mono)' }}>{s.location}</div></td>
...
// ============================================================================
//  Agent workbench — unified view per-specialist
// ============================================================================

function AgentWorkbench({ agentId }) {
    ...
    >
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: 14 }}>
        ...
        <Panel span={6} title="Working memory" kicker={`${memory.length} entries in scope`}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            {memory.slice(-5).reverse().map(m => <MemoryItem key={m.id} m={m}/>)}
          </div>
        </Panel>
      </div>
    </Screen>
...
Object.assign(window, {
  HiveMind, StructureView, CastView, WorldView, ScenesView, AgentWorkbench,
});
